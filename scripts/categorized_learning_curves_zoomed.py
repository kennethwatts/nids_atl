...
# 8. UPDATED VISUALIZATION (DYNAMIC Y-AXIS)
plt.figure(figsize=(12, 7))
colors = ['#e74c3c', '#3498db', '#2ecc71', '#f1c40f', '#9b59b6']

# Find global max F1 for Y-axis scaling
all_f1_values = [val for sublist in results.values() for val in sublist]
max_f1 = max(all_f1_values) if all_f1_values else 1.0
...
# Dynamic Y-axis: Max F1 + 0.05 buffer
...
plt.savefig('categorized_learning_curves_zoomed.png', dpi=300)
print("\nFinal graph saved as 'categorized_learning_curves_zoomed.png'")
plt.show()